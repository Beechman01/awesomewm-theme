...
local hotkeys_popup = require("awful.hotkeys_popup").widget
                      --require("awful.hotkeys_popup.keys") -- commenting out this line removes Tmux keybinds from popup
...
--awful.util.tagnames = { "", "", "", "", "" }
awful.util.tagnames = {"󱅊 ","󱅋 ","󱅌 ","󱅍 ","󱅎 ","󱅏 "}
--awful.util.tagnames = {"","","","","","","",""}
...
awful.spawn.with_shell("~/Documents/Scripts/tablet.sh")
